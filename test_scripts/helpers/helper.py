...
class config_values:
    ...
    epionly_mbd_wash_load2_deck_setup = config['epionly_mbd_wash_load2_deck_setup']
    stop_at_mbd_cleanup = config['stop_at_mbd_cleanup']
    epionly_mbd_cleanup_load1_deck_setup = config['epionly_mbd_cleanup_load1_deck_setup']
